...
<script type="text/javascript">
	function fn_updateMember(){
		document.newMember.action = 'UserUpdate';
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"  action="UserController" method="post" onsubmit="return checkForm();">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="id" type="text" readonly class="form-control" placeholder="id" value="${sessionId }">
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="nickname" type="text" class="form-control" placeholder="nickname" value="${sessionNickname }">
				</div>
			</div>
			<div class="form-group  row ">
				...
				<div class="col-sm-10">
					...
					<input type="text" name="mail1" id="mail1" class="form-control" maxlength="50" value="">@ 
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="button" onclick="checkForm()" class="id_pw_submit" value="회원수정 " > 
					<input type="button" class="id_pw_submit " value="회원탈퇴 " onclick="location.href='DeleteUser'" >
				</div>
			</div>
		</form>
	</div>
