...
<form id="board" name="board" method="post" action="AddBoard">
	<div style="text-align: center;">
		<table border=0 class="table" style="width: 100%;">
			...
			<tbody>
				<tr class="tr">
					<td id="idx" class="td">${board.idx }
					<input type="hidden" name="idx" value="${board.idx }">
					</td>
					<td id="title" class="td, list_tr"><input name="title" class="input" type="text" maxlength=50 value="${board.title }"></td>
					<td id="id" class="td">${board.id }
					<input type="hidden" name="id" value="${board.id }">
					</td>
					<td id="date" class="td">${board.date }
